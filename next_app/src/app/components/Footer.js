// Asegúrate de importar React e Image al principio de tu archivo
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center text-sm font-medium text-gray-500">
            {/* Enlace para About */}
            <li>
              {/* Utiliza Link de Next.js para enlazar al componente About */}
              <Link href="/About">
                <div className="text-gray-800 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-base font-medium cursor-pointer">
                  About
                </div>
              </Link>
            </li>
